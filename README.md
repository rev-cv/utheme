...
| `[A]` | Пометить как "list page" (страница-список) |
| `[W]` | Пометить как "about us" страницу |
| `[N]` | Пометить как "news page" |
...
### Структура 5 — MINIREVIEW_2026

Вариант FSR_2026, в котором домашняя страница живёт в подпапке `hub/`, а не в корне `spec/`.

**Обнаружение:** нет `index.html`/`index.md` в корне, есть папка `hub/` с контентным файлом, нет `PILLAR/` и `HUB/` (uppercase).
...
Флаги — те же, что в FSR_2026. Папка `hub/` не получает флагов.
